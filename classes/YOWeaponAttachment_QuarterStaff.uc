class YOWeaponAttachment_QuarterStaff extends AOCWeaponAttachment_QuarterStaff;

`include(CPM/include/YOWeaponAttachment.uci)

DefaultProperties
{
	WeaponClass=class'YOWeapon_QuarterStaff'
	AttackTypeInfo(0)=(fBaseDamage=40.0, fForce=22500, cDamageType=AOC.AOCDmgType_Blunt, iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=45.0, fForce=22500, cDamageType=AOC.AOCDmgType_Blunt, iWorldHitLenience=6)
