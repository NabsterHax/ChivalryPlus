class YOWeaponAttachment_ShortSpear extends AOCWeaponAttachment_ShortSpear;

`include(CPM/include/YOWeaponAttachment.uci)

DefaultProperties
{
	WeaponClass=class'YOWeapon_ShortSpearMelee'
	...
	AttackTypeInfo(2)=(fBaseDamage=45.0, fForce=20000, cDamageType=AOC.AOCDmgType_Pierce, iWorldHitLenience=6)
