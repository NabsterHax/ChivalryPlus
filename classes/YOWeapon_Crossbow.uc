class YOWeapon_Crossbow extends AOCWeapon_Crossbow;
...
DefaultProperties
{
	...
	AttachmentClass=class'YOWeaponAttachment_Crossbow'
	...
	ConfigProjectileBaseDamage[3]=(Damage=113,InitialSpeed=6375.0,MaxSpeed=6800.0,AmmoCount=15,InitialGravityScale=0.3,Drag=0.000002,PitchCorrection=0)
	...
	ReloadAnimations[0]=(AnimationName=3p_crossbow_reload,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.crossbow_Reload',bFullBody=true,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.0,fAnimationLength=3.5,fBlendInTime=0.1,fBlendOutTime=0.20,bLastAnimation=true,bPlayOnWeapon=true,bAttachArrow=1)
