class YOWeapon_HeavyJavelinThrow extends AOCWeapon_HeavyJavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'YOWeaponAttachment_HeavyJavelinThrow'
	AllowedShieldClass=class'YOShield_Buckler'
	AlternativeMode=class'YOWeapon_HeavyJavelinMelee'
	...
	ConfigProjectileBaseDamage[4]=(Damage=120,InitialSpeed=2125,MaxSpeed=2635,AmmoCount=4,InitialGravityScale=0.85,Drag=0.0000035,PitchCorrection=0)
	...
	WeaponLargePortrait="SWF.weapon_select_javheavy"
	WeaponSmallPortrait="SWF.weapon_select_javheavy"
	...
	WindupAnimations[0]=(AnimationName=3p_javelin_throwwindup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.5,fBlendInTime=0.10,fBlendOutTime=0.10,bLastAnimation=false)
	...
	ReloadAnimations[0]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.6,fAnimationLength=1,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=2)
	ReloadAnimations[1]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=1,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
	ReloadAnimations[2]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=1,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
	ReloadAnimations[3]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=1,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
