class YOWeapon_LightCrossbow extends AOCWeapon_LightCrossbow;
...
DefaultProperties
{
	...
	AttachmentClass=class'YOWeaponAttachment_LightCrossbow'
	...
	ConfigProjectileBaseDamage[3]=(Damage=98,InitialSpeed=5950.0,MaxSpeed=6375.0,AmmoCount=20,InitialGravityScale=0.35,Drag=0.000003,PitchCorrection=0)
	...
	WeaponFontSymbol="e"
	WeaponReach=100
	WeaponLargePortrait="SWF.weapon_select_crossbowlight"
	WeaponSmallPortrait="SWF.weapon_select_crossbowlight"
	...
	ReloadAnimations[0]=(AnimationName=3p_crossbow_reload,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.light_crossbow_Reload',bFullBody=true,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.0,fAnimationLength=2.5,fBlendInTime=0.1,fBlendOutTime=0.2,bLastAnimation=true,bPlayOnWeapon=true,bAttachArrow=1)
