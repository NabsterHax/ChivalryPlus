class YOWeapon_Longbow extends AOCWeapon_Longbow;
...
DefaultProperties
{
	...
	AttachmentClass=class'YOWeaponAttachment_Longbow'
	ConfigProjectileBaseDamage[0]=(Damage=75,InitialSpeed=4675.0,MaxSpeed=5100.0,AmmoCount=25,InitialGravityScale=0.4,Drag=0.0000030,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=75,InitialSpeed=4675.0,MaxSpeed=5100.0,AmmoCount=25,InitialGravityScale=0.4,Drag=0.0000030,PitchCorrection=0)
	ConfigProjectileBaseDamage[2]=(Damage=20,InitialSpeed=4250.0,MaxSpeed=4675.0,AmmoCount=15,InitialGravityScale=0.5,Drag=0.000004,PitchCorrection=0)
	...
	WeaponFontSymbol="t"
	WeaponReach=100
	WeaponLargePortrait="SWF.weapon_select_longbow"
	WeaponSmallPortrait="SWF.weapon_select_longbow"
	...
	WindupAnimations[0]=(AnimationName=3p_longbow_draw,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Longbow_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=0.6,fAnimationLength=1.2,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true)
