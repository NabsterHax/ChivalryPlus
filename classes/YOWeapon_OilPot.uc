class YOWeapon_OilPot extends AOCWeapon_OilPot;
...
DefaultProperties
{
	...
	WeaponProjectiles(0)=class'YOProj_ThrownOilPot'

	AttachmentClass=class'YOWeaponAttachment_OilPot'
	...
	ConfigProjectileBaseDamage[5]=(Damage=0,InitialSpeed=1700.0,MaxSpeed=2975.0,AmmoCount=1,InitialGravityScale=0.9,Drag=0.000001,PitchCorrection=60.0)
	
	iFeintStaminaCost=0
	WeaponFontSymbol="k"
	WeaponReach=100
	WeaponLargePortrait="SWF.weapon_select_firepot"
	WeaponSmallPortrait="SWF.weapon_select_firepot"
