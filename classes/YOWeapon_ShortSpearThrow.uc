class YOWeapon_ShortSpearThrow extends AOCWeapon_ShortSpearThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'YOWeaponAttachment_ShortSpearThrow'
	AllowedShieldClass=class'YOShield_Buckler'
	AlternativeMode=class'YOWeapon_ShortSpearMelee'
	...
	ConfigProjectileBaseDamage[4]=(Damage=105,InitialSpeed=2550.0,MaxSpeed=2975.0,AmmoCount=6,InitialGravityScale=0.85,Drag=0.000003,PitchCorrection=0)
	...
	WeaponLargePortrait="SWF.weapon_select_javshort"
	WeaponSmallPortrait="SWF.weapon_select_javshort"
	...
	WindupAnimations[0]=(AnimationName=3p_javelin_throwwindup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.3,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false)
	...
	ReloadAnimations[0]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.7,fAnimationLength=0.8,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=2)
	ReloadAnimations[1]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.8,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
	ReloadAnimations[2]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.8,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
	ReloadAnimations[3]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.8,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
