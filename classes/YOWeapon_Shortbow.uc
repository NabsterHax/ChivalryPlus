class YOWeapon_Shortbow extends AOCWeapon_Shortbow;
...
DefaultProperties
{
	...
	AttachmentClass=class'YOWeaponAttachment_Shortbow'
	
	ConfigProjectileBaseDamage[0]=(Damage=55,InitialSpeed=4675.0,MaxSpeed=5100.0,AmmoCount=35,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=55,InitialSpeed=4675.0,MaxSpeed=5100.0,AmmoCount=35,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=0)
	ConfigProjectileBaseDamage[2]=(Damage=10,InitialSpeed=3825.0,MaxSpeed=4500.0,AmmoCount=15,InitialGravityScale=0.6,Drag=0.000004,PitchCorrection=0)
	...
	WeaponFontSymbol="i"
	WeaponReach=100
	WeaponLargePortrait="SWF.weapon_select_shortbow"
	WeaponSmallPortrait="SWF.weapon_select_shortbow"
	...
	WindupAnimations[0]=(AnimationName=3p_longbow_draw,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.shortbow_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=0.75,fAnimationLength=0.9,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true)
