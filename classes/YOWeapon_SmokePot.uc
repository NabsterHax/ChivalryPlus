class YOWeapon_SmokePot extends AOCWeapon_SmokePot;
...
DefaultProperties
{
	...
	AttachmentClass=class'YOWeaponAttachment_SmokePot'
	...
	ConfigProjectileBaseDamage[5]=(Damage=0,InitialSpeed=1275.0,MaxSpeed=1700.0,AmmoCount=2,InitialGravityScale=1.0,Drag=0.000001,PitchCorrection=60.0)
	...
	WindupAnimations[0]=(AnimationName=3p_1hsharp_throwdowntoup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.broadsword_windup',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=1.0,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
