class YOWeapon_Warbow extends AOCWeapon_Warbow;

`include(CPM/include/YOWeapon.uci)

//Temp fix to bow replication bug - other half is in CPMPlayerController --no need
/*
simulated function CancelRangedAttack()
{
	GotoState('Recovery');
	ServerCancelRangedAttack();
	ClientCancelRangedAttack();
}
reliable server function ServerCancelRangedAttack()
{
	GotoState('Recovery');
}*/
...
DefaultProperties
{
	...
	AttachmentClass=class'YOWeaponAttachment_Warbow'

	ConfigProjectileBaseDamage[0]=(Damage=105,InitialSpeed=4675.0,MaxSpeed=5100.0,AmmoCount=20,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=105,InitialSpeed=4675.0,MaxSpeed=5100.0,AmmoCount=20,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	ConfigProjectileBaseDamage[2]=(Damage=30,InitialSpeed=5100.0,MaxSpeed=6500,AmmoCount=15,InitialGravityScale=0.55,Drag=0.000005,PitchCorrection=240.0)
	ConfigProjectileBaseDamage[3]=(Damage=0,InitialSpeed=5100.0,MaxSpeed=6800.0,AmmoCount=30,InitialGravityScale=1.0,Drag=0.0000011,PitchCorrection=300.0)
	ConfigProjectileBaseDamage[4]=(Damage=0,InitialSpeed=5100.0,MaxSpeed=6800.0,AmmoCount=30,InitialGravityScale=1.0,Drag=0.0000011,PitchCorrection=300.0)
	ConfigProjectileBaseDamage[5]=(Damage=0,InitialSpeed=5100.0,MaxSpeed=6800.0,AmmoCount=30,InitialGravityScale=1.0,Drag=0.0000011,PitchCorrection=300.0)
	
	iFeintStaminaCost=0
	WeaponFontSymbol="@"
	WeaponReach=100
	WeaponLargePortrait="SWF.weapon_select_warbow"
	WeaponSmallPortrait="SWF.weapon_select_warbow"
